...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button type="button" class="btn btn-primary" id="create-role-btn">Create Role</button>
</div>
...
<div class="card shadow-sm mb-4">
    <div class="card-body">
        <form id="filter-form" class="row align-items-end g-3">
            <div class="col-md-6">
                <label for="filter-name" class="form-label small fw-bold">Role Name</label>
...
<!-- Role Modal -->
<div class="modal fade" id="role-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="roleModalLabel" aria-hidden="true">
